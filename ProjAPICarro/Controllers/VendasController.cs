...
namespace ProjAPICarro.Controllers
{
    ...
    public class VendasController : ControllerBase
    {
        ...
        public async Task<IActionResult> PutVenda(int id, VendaDTO vendaDTO)
        {
            ...
            venda.Carro = _context.Carro.Find(vendaDTO.CarroPlaca);
            venda.Cliente = _context.Cliente.Find(vendaDTO.ClienteDocumento);
            venda.Funcionario = _context.Funcionario.Find(vendaDTO.FuncionarioDocumento);
